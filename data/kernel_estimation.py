...
l = 13
us = scipy.io.loadmat(
    '/workdir/MLFormer/data/kernel_estimation/grf1d_N2000_s8193_m0_gamma1_tau1_sigma1_dirichlet.mat')['f']
...
for kernel in tqdm(kernel_types, total=len(kernel_types)):
    ...
    np.save('/workdir/MLFormer/data/kernel_estimation/{:}_8193.npy'.format(kernel), ws)
